...
def parse_spy_prices() -> pd.DataFrame:
    ...
    # Вбудовані реальні дані SPY (щомісячно 2015–2019)
    """
    raw = [
        ("2015-01-02",201.02),("2015-02-02",210.44),("2015-03-02",208.60),
        ("2015-04-01",210.21),("2015-05-01",213.14),("2015-06-01",208.35),
        ("2015-07-01",211.97),("2015-08-03",197.52),("2015-09-01",190.35),
        ("2015-10-01",203.45),("2015-11-02",208.00),("2015-12-01",200.48),
        ("2016-01-04",192.03),("2016-02-01",191.07),("2016-03-01",203.51),
        ("2016-04-01",206.33),("2016-05-02",208.35),("2016-06-01",204.04),
        ("2016-07-01",215.46),("2016-08-01",217.39),("2016-09-01",215.87),
        ("2016-10-03",212.35),("2016-11-01",220.38),("2016-12-01",224.35),
        ("2017-01-03",227.05),("2017-02-01",236.47),("2017-03-01",235.74),
        ("2017-04-03",236.77),("2017-05-01",241.30),("2017-06-01",241.80),
        ("2017-07-03",246.76),("2017-08-01",246.10),("2017-09-01",250.35),
        ("2017-10-02",256.39),("2017-11-01",260.97),("2017-12-01",266.86),
        ("2018-01-02",278.20),("2018-02-01",261.61),("2018-03-01",257.30),
        ("2018-04-02",261.49),("2018-05-01",268.75),("2018-06-01",271.46),
        ("2018-07-02",280.36),("2018-08-01",289.59),("2018-09-04",290.87),
        ("2018-10-01",267.90),("2018-11-01",269.64),("2018-12-03",233.00),
        ("2019-01-02",249.92),("2019-02-01",278.88),("2019-03-01",279.97),
        ("2019-04-01",290.63),("2019-05-01",278.18),("2019-06-03",293.06),
        ("2019-07-01",300.87),("2019-08-01",292.45),("2019-09-03",299.41),
        ("2019-10-01",299.43),("2019-11-01",314.47),("2019-12-02",319.31),
    ]
    prices_m = np.array([p for _, p in raw])
    prices_i = np.interp(
        np.linspace(0, len(prices_m)-1, 300),
        np.arange(len(prices_m)), prices_m
    )
    dates_i = pd.date_range("2015-01-02", periods=300, freq="B")
    df = pd.DataFrame({"Date": dates_i[:300], "Close": prices_i,
                       "Open": prices_i*0.999, "High": prices_i*1.005,
                       "Low": prices_i*0.995, "Volume": [80000000]*300})
    print(f"Вбудовані дані SPY: {len(df)} точок (інтерпольовано)")
    return df
    """
